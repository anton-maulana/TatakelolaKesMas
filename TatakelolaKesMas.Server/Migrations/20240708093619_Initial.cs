...
namespace TatakelolaKesMas.Server.Migrations
{
    /// <inheritdoc />
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PublicHealthCenters", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PublicHealthCenters_Regions_FkRegionId",
                        column: x => x.FkRegionId,
                        principalTable: "Regions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PublicHealthCenters_FkRegionId",
                table: "PublicHealthCenters",
                column: "FkRegionId");
